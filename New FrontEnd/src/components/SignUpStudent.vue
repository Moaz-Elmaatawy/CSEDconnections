<template class="bodySignUpStudent">
    ...
    <template class="bodySignUpStudent">
      ...
      <form class="signupformStudent">
        ...
        <div class="form-group">
          ...
          <input class="rectangle" type="text" v-model="profilePicture"  placeholder=" Your Profile Picture URL" maxlength="200" />
        </div>     
        ...
        <div class="form-group">
          <label for="user">Expected Graduation Year</label>
          <input class="rectangle" type="text" v-model="expectedgraduationyear"  placeholder=" 2023" maxlength="4" required/>
        </div>   
        ...
        <div class="form-group">
        <button class="button" @click=signUpAsStudent()>Sign Up</button>
        </div>
        
        <div class="form-group">
        <a href="" @click=backSignUpStudent()>Back</a>
        </div>
