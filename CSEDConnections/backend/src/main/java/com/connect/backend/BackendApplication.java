...
public class BackendApplication {
	public static void main(String[] args) {
		...
		// Graduate user=new Graduate("Moaz Nabil","M" , "0100000" ,"Hi" , "23-2-2000" ,
		// "omarShonshory@gmail.com" , "123456879" , "url","2023" );
		// user.addExperience(new Experience("companyName", "location", "startDate",
		// "endDate", "position"));
